    ...
    partial class RandomFeatures
    {
        ...
        public void RandomFeaturesMenu(int idIn, out int idPop)
        {
            ...
            if (ImGui.TreeNode("Specter Bodies"))
            {
				...
				Settings.SyndicateOperative.Value = ImGuiExtension.Checkbox("Syndicate Operative", Settings.SyndicateOperative);
                ImGui.TreePop();
            }
        ...
        private void SpectreLabels()
        {
            if (Settings.Specters)
            {
				...
				if (Settings.SyndicateOperative)
				{
					DrawTextLabelSpecter(Color.Yellow, "Syndicate Operative", "Metadata/Monsters/LeagueBetrayal/BetrayalOriathBlackguardRanged", 120);
				}
            }
        }
